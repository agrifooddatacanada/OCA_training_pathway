...
You can control the format of the data by [modifying the format overlay](add_format_values.md). The format values entered for the format overlay are dependent on the [attribute types](create_first_schema.md#attribute-types) defined in the Capture Base.
