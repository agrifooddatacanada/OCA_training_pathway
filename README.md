...
In an Excel Template, you could choose to [add format values](add_format_values.md) to certain attributes. Format values restrict the formatting of the data, and any data entries that do not conform to the format will be filtered out during [OCA data set validation](validate_OCA_data_set.md).
